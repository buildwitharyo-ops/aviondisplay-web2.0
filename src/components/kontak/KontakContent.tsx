      ...
      {state === "success" ? (
        ...
        >
          ...
          <div>
            ...
            >
              Tim kami akan menghubungi Anda dalam 1 hari kerja.
            </p>
          </div>
          <button
        ...
        >
          ...
          {state === "error" && (
            <p style={{ fontSize: "0.8rem", color: "var(--red)", margin: 0 }}>
              Gagal mengirim pesan. Silakan coba lagi atau hubungi kami via
              WhatsApp.
            </p>
          )}
...
export default function KontakContent() {
  return (
    <section
      style={{ padding: "2rem 0 6rem", borderTop: "1px solid var(--border)" }}
    >
