...
const WA_URL = "https://api.whatsapp.com/send/?phone=6281563905555&text=Halo,+saya+mau+bertanya+tentang+AVION+Display!";
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        >
          ...
          <div style={{
            ...
            width: 600,
            height: 400,
            background: "radial-gradient(ellipse, rgba(107,92,255,0.15) 0%, transparent 70%)",
            pointerEvents: "none",
          }} />
